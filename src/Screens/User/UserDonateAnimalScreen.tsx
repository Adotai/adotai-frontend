...
export default function UserDonateAnimalScreen({ navigation, route }: any) {
  const ongId = route?.params?.ongId ?? null;
    ...
    <View style={{ alignItems: 'center', width: '100%', backgroundColor: Theme.BACK , height: '100%' }}>
      {loading && (
        <View style={styles.loadingOverlay}>
          ...
          <Text style={{ color: Theme.PRIMARY, fontFamily: 'Poppins-SemiBold', marginTop: 10 }}>Enviando animal...</Text>
        </View>
      )}
